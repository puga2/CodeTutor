            ...
            <div className='container mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 relative'>
                ...
                <div className='flex md:flex-row items-center flex-col justify-between gap-8'>
                    ...
                    <div  className='flex sm:flex-row gap-8 shrink-0'>
                        <Link to="/start-building" className="bg-[#4353ff] hover:bg-blue-700 px-8 py-4 text-lg font-medium transition-colors rounded-sm text-white duration-200" >
                        Start building</Link>
                        <Link to="/start-building" className=" hover:text-white/40 flex items-center px-8 group py-4 text-lg font-medium transition-colors rounded-sm text-white duration-200" >
